...
const About = () => {
  ...
  return (
    <div className="w-full">
      ...
      {/* About Section */}
      <section ref={aboutRef} className="py-20 md:py-32 px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <section ref={doctorRef} className="py-20 md:py-32 px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-center">
      ...
      <section ref={approachRef} className="py-20 md:py-32 px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      {/* CTA Section */}
      <section ref={ctaRef} className="py-24 bg-primary text-white text-center px-6">
